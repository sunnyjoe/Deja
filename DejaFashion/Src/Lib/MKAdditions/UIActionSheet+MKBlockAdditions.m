...
+ (void) pickPhotoFromAlbum:(UIView*) showInView
                  presentVC:(UIViewController*) presentVC
              onPhotoPicked:(PhotoPickedBlock) photoPicked
                   onCancel:(CancelBlock) cancelled
{
    ...
    sheet.tag = kPhotoActionSheetTag;
    [UIActionSheet actionSheet:sheet didDismissWithButtonIndex:1];
}

+ (void) pickPhotoFromCamera:(UIView*) showInView
                   presentVC:(UIViewController*) presentVC
               onPhotoPicked:(PhotoPickedBlock) photoPicked
                    onCancel:(CancelBlock) cancelled
{
    ...
    UIActionSheet *sheet = [UIActionSheet new];
    sheet.tag = kPhotoActionSheetTag;
    [UIActionSheet actionSheet:sheet didDismissWithButtonIndex:0];
